        ...
        return ( 
            ...
            <React.Fragment>
                ...
                <header>
                    ...
                    <div className="tab">
                    <button className="tab__link" onClick={this.openChart(event,'last7days')} id="tab__link--default-open">Last
                        7 days</button>
                    <button className="tab__link tab__link--active" onClick={this.openChart(event,'last28days')}>Last 28 days</button>
                    <button className="tab__link" onClick={this.openChart(event,'last90days')}>Last 90 days</button>
                    </div>
                </header>
