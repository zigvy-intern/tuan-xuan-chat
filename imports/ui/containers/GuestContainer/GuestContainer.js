            ...
            <React.Fragment>
                <div className="info border-box">
                    ...
                    <section className="grid-row border-bottom">
                        ...
                        <FormInput placeholder="Type a name and hit Enter" />
                    </section>
                    {/* Detail */}
                    ...
                    <section className="info__option">
                        <Button color="red" size="large" name="Delete this person" />
                        <Button color="yellow" size="large" name="Block this person" />
                        <Button color="blue" size="large" name="Unsubcribe from email" />
                    </section>
                </div>
